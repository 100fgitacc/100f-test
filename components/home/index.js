            ...
            <div className={styles['card-section']}>
              ...
              <div className={styles['sales-system']}>
                <div className={styles['sales-system-item']}>
                  ...
                  {isMobile ? (<Image src='/assets/img/AutowebMiro.png' width={229} height={400} />) : (<img src='/assets/img/Miro-m.png' width={229} height={285} />)}
                  <img src='/assets/img/Bandle.png' width={229} height={167}  />
                </div>
                <div className={styles['sales-system-item']}>
