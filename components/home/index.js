          ...
          <span className={styles['section-count']}>1</span>
            <div className={styles['card-section']}>
              ...
              <div className={styles['sales-system']}>
                <div className={styles['sales-system-item']}>
                  ...
                  {isMobile ? (<Image src='/assets/img/social_img.png' width={229} height={400} />) : (<img src='/assets/img/social_img.png' width={229} height={285} />)}
                  <img src='/assets/img/social_imgpng' width={229} height={167}  />
                </div>
                <div className={styles['sales-system-item']}>
            ...
            <div className={styles['card-section']}>
              ...
              <div>
                ...
                <div className={styles['team-group']}>
                  <h4 className={styles['team-title']}>C-level</h4>
